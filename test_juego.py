...
class TestJuego(unittest.TestCase):
    ...
    # agregar pruebas para casos limite
    def test_no_permitir_movimiento_fuera_del_tablero(self):

        juego = Juego()

        with self.assertRaises(IndexError):
            juego.realizar_movimiento(5,5)
    
    def test_no_permitir_movimientos_despues_de_finalizar(self):
